...
![favorites_chrome](http://www.agcto.com/assets/images/2016/favorites_chrome.jpg)  
...
主页  
![favorites_chrome](http://www.agcto.com/assets/images/2016/favorites_index.png)  

注册  
![favorites_chrome](http://www.agcto.com/assets/images/2016/favorites_register.png)  

首页  
![favorites_chrome](http://www.agcto.com/assets/images/2016/favorites_home.png)  

收藏  
![favorites_chrome](http://www.agcto.com/assets/images/2016/favorites_collect.png)  


## 技术点

这段时间我们团队主要在学习spring boot,这个开源项目也就成了我们的练习新技术的一个非常好的产品，主要的技术都是和spring boot相关，可以参考我以前文章 [spring boot系列文章](http://www.agcto.com/spring-boot)
...
前端页面由[Angle - Bootstrap Admin theme](https://wrapbootstrap.com/theme/angle-bootstrap-admin-template-WB04HF123)这套主题改造而来;模版引擎使用了```thymeleaf```，可以参考这篇文章：[springboot(四)：thymeleaf使用详解](http://www.agcto.com/springboot/2016/05/01/springboot(%E5%9B%9B)-thymeleaf%E4%BD%BF%E7%94%A8%E8%AF%A6%E8%A7%A3.html)
 
**持久层**

数据库主要使用了 Spring data jpa模版来实现，可以参考这篇文章：[springboot(五)：spring data jpa的使用](http://www.agcto.com/springboot/2016/08/20/springboot(%E4%BA%94)-spring-data-jpa%E7%9A%84%E4%BD%BF%E7%94%A8.html)
...
**[示例代码-码云](https://gitee.com/agcto/favorites-web)**


-------------

**作者：大龄码农**  
**出处：[http://www.agcto.com/](http://www.agcto.com/)**    
**版权所有，欢迎保留原文链接进行转载：)**