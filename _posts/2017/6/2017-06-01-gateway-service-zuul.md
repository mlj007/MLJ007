...
{:.center}
![](http://www.agcto.com/assets/images/2017/springcloud/bff.png)
...
{:.center}
![](http://www.agcto.com/assets/images/2017/springcloud/bff-process.png)
...
#这里的配置表示，访问/it/** 直接重定向到http://www.agcto.com/**
zuul.routes.baidu.path=/it/**
zuul.routes.baidu.url=http://www.agcto.com/
```
...
启动```gateway-service-zuul-simple```项目，在浏览器中访问：```http://localhost:8888/it/spring-cloud```，看到页面返回了：```http://www.agcto.com/spring-cloud ``` 页面的信息，如下：

{:.center}
![](http://www.agcto.com/assets/images/2017/springcloud/zuul-01.jpg)
